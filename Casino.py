...
#TODO: покер с ии для блефа. Несколько игроков, у каждого своя стратегия (случайным образом), 
# кто-то математически считает, кто-то просто уравнивает и т.д.; 
# рулетка.
# разбить на отдельные файлы и подключать
